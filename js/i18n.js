document.addEventListener("DOMContentLoaded", () => {
  const translations = {
      ...
      review_6_text: "<strong>Keittiökalusteiden purku ja uusien runkojen asennus sekä työtason sovitus (15.10.2026)</strong><br>Työ oli laaja, mutta aikataulu piti ja lopputulos on siisti ja tarkka.",
      review_6_author: "Espoo",
      review_7_text: "<strong>Saunan lauteiden uusiminen, paneloinnin korjaus ja LED-valaistuksen asennus (02.11.2026)</strong><br>Hyvä suunnittelu ja huolellinen toteutus. Sauna näyttää ja tuntuu kuin uudelta.",
      review_7_author: "Vantaa",
      review_8_text: "<strong>Parketin paikallinen korjaus, listoitus ja kynnyksen vaihto (18.11.2026)</strong><br>Pieniä yksityiskohtia paljon, mutta kaikki saatiin nätisti kohdilleen.",
      review_8_author: "Kirkkonummi",
      review_9_text: "<strong>Kylpyhuoneen silikonisaumojen uusinta, kaapin kiinnitys ja ilmanvaihdon säätö (05.12.2026)</strong><br>Kaikki tehtiin huolellisesti ja jätettiin siististi. Nopea reagointi yhteydenottoon.",
    ...
    en: {
      ...
      review_5_author: "Helsinki",
      review_6_text: "<strong>Kitchen unit removal, new cabinet frame installation and countertop fitting (15.10.2026)</strong><br>A big job, but the schedule held and the finish is clean and precise.",
      review_6_author: "Espoo",
      review_7_text: "<strong>Sauna bench renewal, paneling repair and LED lighting installation (02.11.2026)</strong><br>Great planning and careful execution. The sauna looks and feels like new.",
      review_7_author: "Vantaa",
      review_8_text: "<strong>Local parquet repair, skirting installation and threshold replacement (18.11.2026)</strong><br>Lots of small details, but everything was aligned nicely.",
      review_8_author: "Kirkkonummi",
      review_9_text: "<strong>Bathroom silicone joint replacement, cabinet mounting and ventilation adjustment (05.12.2026)</strong><br>Everything was done carefully and left tidy. Quick response to the inquiry.",
      review_9_author: "Kauniainen",
    ...
    ru: {
      ...
      review_6_text: "<strong>Демонтаж кухонных модулей, установка новых каркасов и подгонка столешницы (15.10.2026)</strong><br>Объёмная работа, но сроки выдержали, результат аккуратный и точный.",
      review_6_author: "Эспоо",
      review_7_text: "<strong>Обновление полков в сауне, ремонт панелей и монтаж LED-подсветки (02.11.2026)</strong><br>Отличное планирование и аккуратное исполнение. Сауна как новая.",
      review_7_author: "Вантаа",
      review_8_text: "<strong>Локальный ремонт паркета, установка плинтусов и замена порога (18.11.2026)</strong><br>Много мелких нюансов, но всё сделали ровно и красиво.",
      review_8_author: "Киркконумми",
      review_9_text: "<strong>Замена силиконовых швов в ванной, крепление шкафа и регулировка вентиляции (05.12.2026)</strong><br>Сделали аккуратно и оставили всё чистым. Быстро отреагировали на обращение.",
